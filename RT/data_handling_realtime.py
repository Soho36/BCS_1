...
# File with signal generated by Python script   # HASH FOLDER MUST BE CHANGED BEFORE EXE BUILD
# buy_sell_signals_for_mt5_filepath = (
#      f'C:\\Users\\Liikurserv\\AppData\\Roaming\\MetaQuotes\\Terminal\\09FF355D73768D9CE6BDD4EE575EAB09\\MQL5\\Files\\'
#      f'buy_sell_signals_from_python.txt'
#      )

# File with signal generated by Python script for NinjaTrader script:
buy_sell_signals_for_ninja_filepath = (
     f'C:\\Users\\Liikurserv\\PycharmProjects\\BCS_1\\RT\\trade_signal.txt'
     )
...
#      )
# levels_path = ('C:\\Users\\Vova deduskin lap\\AppData\\Roaming\\MetaQuotes\\Terminal\\D0E8209F77C8CF37AD8BF550E51FF075\\MQL5\\Files\\hardcoded_sr_levels.csv')
...
def save_order_parameters_to_file(line_order_parameters):   # Called from orders_sender.py
    with open(buy_sell_signals_for_ninja_filepath, 'w', encoding='utf-8') as file:
